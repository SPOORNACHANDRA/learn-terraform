...
resource "null_resource" "ansible" {
  ...
  provisioner "local-exec" {
    command = <<EOF
cd /home/centos/ansible-roboshop
git pull
sleep 30
ansible-playbook -i frontend-dev.poornadevops.online, main.yml -e ansible_user=centos -e ansible_password=DevOps321 frontend.yml
